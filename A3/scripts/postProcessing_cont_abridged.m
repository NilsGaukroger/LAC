% 46320 LAC Course
% Assignment 3: Post-processing (abridged for Individual Assignment)
...
%% Inputs
full_load = [0.055, 0.650]; % fn [Hz], zeta [-]
operation = 1;              % 0 constant torque, 1 constant power
...
%% Create table of controller parameters
[gains,genTorque_switch] = controllerTable(full_load,operation);
...
%     else
%         filename = strcat('../data/gains_C', num2str(i), '.dat');
%         write_gains(gains,genTorque_switch,redesign,filename,i)
%     end
% end
% if i == 7
%     filename = '../../data/redesign/controller_gains.dat';
%     write_gains(gains,genTorque_switch,redesign,filename,i);
% end
% 
