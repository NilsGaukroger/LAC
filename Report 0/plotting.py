...
if save == True:
    plt.savefig('Part1_subplots.pdf',bbox_inches='tight')
plt.show()
...
if save == True:
    plt.savefig('Part2a_subplots.pdf')
plt.show()
...
axs[2,1].set(xlabel='Spanwise position [m]')
if save == True:
    plt.savefig('Part2b_subplots.pdf',bbox_inches='tight')
plt.show()
...
axs[2].grid(True)
if save == True:
    plt.savefig('Part3_subplots.pdf',bbox_inches='tight')
plt.show()
...
axs[2,1].set(xlabel='Spanwise position [m]')
if save == True:
    plt.savefig('Bonus_subplots.pdf',bbox_inches='tight')
plt.show()
...
if save == True:
    plt.savefig('Bonusa_subplots.pdf')
plt.show()