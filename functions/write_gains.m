function write_gains(gains,genTorque_switch,redesign,i)
fileID = fopen(strcat('../data/gains_C', num2str(i), '.dat'), 'w');
fprintf(fileID,['; Overall parameters\n',...
'        constant	1 10000;	Rated power [kW]\n',...
'        constant	2 0;	Minimum rotor (LSS) speed [rad/s]\n',...
'        constant	3 0.774;	Rated rotor (LSS) speed [rad/s]\n',...
...
';     Turbine parameter\n',...
'        constant	47 %.4f;	Nominal rotor diameter [m]\n',...
...
'        constant	49 %.1f;	Optimal tip speed ratio [-] (only used when K=constant 11 = 0 otherwise  Qg=K*Omega^2 is used)\n',...
...
'	     constant 	82 %.1f;    Rated wind speed (Only used when constant 79 = 3 OR constant 95 = 0)\n',...
...
'		 constant  	85 9999.0; 	Time to switch on the floating control loop [s]\n',...
...
gains.("Region 3: K1")(i),gains.("Region 3: K2")(i),redesign.R*2,redesign.tsr_opt,redesign.V_rated);
fprintf(fileID,'exit;');
fclose(fileID);
end