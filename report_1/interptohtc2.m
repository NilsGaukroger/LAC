...
z = (n-1)/(nsec).*(rotor.R-rotor.r(1));
twist=interp1(rotor.r,rad2deg(result.beta),z+rotor.r(1));
chord=interp1(rotor.r,result.c,z+rotor.r(1));
relthicc=interp1(rotor.r,rotor.t./result.c*100,z+rotor.r(1));
twist(1)=twist(2);
chord(1)=chord(2);
